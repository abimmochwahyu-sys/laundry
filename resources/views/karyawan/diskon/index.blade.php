...
@section('title', 'Data Diskon - Karyawan')
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3 mb-0 text-gray-800">Data Diskon</h1>
        <a href="{{ route('karyawan.diskon.create') }}" class="btn btn-primary">
            + Tambah Diskon
        </a>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('karyawan.diskon.edit', $diskon) }}"
                                           class="btn btn-warning btn-sm">
                                            Edit
                                        </a>
                                        <form action="{{ route('karyawan.diskon.toggle-status', $diskon) }}"
                                        ...
                                        <form action="{{ route('karyawan.diskon.destroy', $diskon) }}"
                                              method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
