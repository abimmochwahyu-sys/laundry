...
@section('content')
    <h1 class="h3 mb-4 text-gray-800">Edit Diskon</h1>

    <div class="card shadow">
        <div class="card-header">
            <h6 class="m-0 font-weight-bold text-primary">Form Edit Diskon</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('karyawan.diskon.update', $diskon) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_diskon') is-invalid @enderror"
                               ...
                               value="{{ old('kode_diskon', $diskon->kode_diskon) }}" required
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('minimum_belanja') is-invalid @enderror"
                                   ...
                                   value="{{ old('minimum_belanja', $diskon->minimum_belanja) }}" required
                                   placeholder="0">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('berlaku_sampai') is-invalid @enderror"
                               ...
                               value="{{ old('berlaku_sampai', $diskon->berlaku_sampai->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                                   ...
                                   {{ old('is_active', $diskon->is_active) ? 'checked' : '' }}>
